  ...
  <div>
    ...
    <v-content>
      <v-container fluid>
        ...
        <v-row>
          <v-col v-for="(item, index) of toolsPackages" :key="index">
            <v-card
              class="mx-auto"
              max-width="344"
              outlined
            >
              ...
              <v-card-actions>
                ...
                <v-btn
                  text
                  v-on:click="modalPackage(toolsPackages ,item.name)"
                >
                  Information
                </v-btn>
              </v-card-actions>
